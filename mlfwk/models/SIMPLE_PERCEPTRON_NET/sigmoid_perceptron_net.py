...
class sigmoid_perceptron_network:
    ...
    def k_fold_cross_validate(self, x, y, alphas):
        ...
        for alpha in alphas:
            ...
            for esimo in range(1, K + 1):
                ...
                classifier = sigmoid_perceptron_network(epochs=self.epochs,
    ...
    def backward(self, error, x, y):
        ...
        for neuron_key in self.network.keys():
            ...
            adjust = learning_rule_perceptron(y_neuron*(1 - y_neuron), error[neuron_key], array(x, ndmin=2), self.learning_rate)
