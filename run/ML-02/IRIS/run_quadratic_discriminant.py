...
if __name__ == '__main__':
    ...
    for realization in range(20):
        ...
        quadractic_clf = quadraticDiscriminant(classes, features, 'Species')
    ...
    pd.DataFrame(final_result).to_csv(get_project_root() + '/run/ML-02/IRIS/results/' + 'result_quadractic_discriminant.csv')
