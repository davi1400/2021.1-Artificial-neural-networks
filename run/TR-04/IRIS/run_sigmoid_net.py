...
if __name__ == '__main__':
    ...
    for realization in range(20):
        ...
        simple_net = sigmoid_perceptron_network(epochs=10000, number_of_neurons=3, learning_rate=0.01)
    ...
    pd.DataFrame(final_result).to_csv(get_project_root() + '/run/TR-04/IRIS/results/' + 'result_simple_net.csv')
