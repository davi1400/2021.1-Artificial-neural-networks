...
if __name__ == '__main__':
    ...
    for realization in range(20):
        ...
        validation_alphas = [0.3, 0.5, 0.7]
        hidden = [10, 11, 12, 13, 14]
        simple_net = RadialBasisFunction(number_of_neurons=12, N_Classes=3, alpha=0.3, case='classification')
    ...
    pd.DataFrame(final_result).to_csv(get_project_root() + '/run/TR-06/COLUNA_3C/results/' + 'result_rbf.csv')
