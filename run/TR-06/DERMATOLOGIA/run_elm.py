...
if __name__ == '__main__':
    ...
    for realization in range(20):
        ...
        number_of_neourons = np.arange(1, 50)
        simple_net = ExtremeLearningMachines(number_of_neurons=35, N_Classes=6, case='classification')
    ...
    pd.DataFrame(final_result).to_csv(get_project_root() + '/run/TR-06/DERMATOLOGIA/results/' + 'result_elm.csv')
